  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <motion.div
        ...
        className="mb-2"
      >
        <h2 className="text-lg font-semibold tracking-wide uppercase text-primary mb-4">
          ¿QUÉ QUIERES HACER?
        </h2>
        ...
        {kpis.map((kpi, i) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span
                className={`flex items-center text-xs font-medium gap-0.5`}
                style={{
                  color: kpi.up ? "hsl(145, 60%, 55%)" : "hsl(0, 72%, 60%)",
                }}
              >
                {kpi.up ? (
            ...
            <div className="text-xs" style={{ color: "hsl(210, 15%, 50%)" }}>
              {kpi.label}
            </div>
          </motion.div>
        ))}
      ...
      >
        <h2
          className="text-sm font-semibold mb-6 tracking-wide uppercase flex items-center gap-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {featureButtons.map((btn, i) => (
            ...
            >
              <Link
                to={btn.path}
                className="kpi-card hover:shadow-glow p-5 rounded-xl h-full flex flex-col items-center gap-3 text-center transition-all group-hover:-translate-y-1"
              >
                <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-3">
            {recentActivity.map((act, i) => (
              <motion.div
                ...
                style={{
                  background: "hsl(210 35% 8% / 0.6)",
                  border: "1px solid hsl(210 30% 14%)",
                }}
              >
                <div
        ...
        >
            ...
            <div key={i} className="space-y-1.5">
              ...
              <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "hsl(210 30% 15%)" }}>
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(90deg, hsl(195, 100%, 50%), hsl(220, 90%, 55%))",
                  }}
                />
              </div>
            </div>
          ...
          >
            <p className="text-xs" style={{ color: "hsl(195, 60%, 70%)" }}>
              Próxima declaración
            </p>
            <p className="text-lg font-bold mt-1" style={{ color: "hsl(195, 100%, 65%)" }}>
              17 Mar 2026
            </p>
